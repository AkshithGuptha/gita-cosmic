...
function startAmbientSound() {
  ...
  globalOscillators = frequencies.map((freq, i) => {
    ...
    osc.type = "sine";
    oscGain.gain.value = 0.015 - i * 2e-3;
    osc.connect(oscGain);
...
function useAudio() {
  const [isPlaying, setIsPlaying] = reactExports.useState(() => {
...
Service({
  "getChapter": Func([Nat], [Opt(ChapterMeta)], ["query"]),
  "getChapterSlokas": Func([Nat], [Vec(Sloka)], ["query"]),
  "getChapters": Func([], [Vec(ChapterMeta)], ["query"]),
  "getDailySloka": Func([], [Opt(Sloka)], ["query"]),
  "getSloka": Func([Nat, Nat], [Opt(Sloka)], ["query"]),
  "searchSlokas": Func(
    [Text, Nat, Nat],
    [PagedResult],
    ["query"]
...
const idlFactory = ({ IDL: IDL2 }) => {
  const ChapterMeta2 = IDL2.Record({
    "chapterNumber": IDL2.Nat,
    "sanskritName": IDL2.Text,
    "totalSlokas": IDL2.Nat,
    "summary": IDL2.Text,
    "englishName": IDL2.Text
  });
  const MultiLangText2 = IDL2.Record({
    "hindi": IDL2.Text,
    "telugu": IDL2.Text,
    "sanskrit": IDL2.Text,
    "english": IDL2.Text
  });
  const Sloka2 = IDL2.Record({
    "chapterNumber": IDL2.Nat,
    "meanings": MultiLangText2,
    "sanskritText": IDL2.Text,
    "explanation": IDL2.Text,
    "transliteration": IDL2.Text,
    "slokaNumber": IDL2.Nat
  });
  const PagedResult2 = IDL2.Record({
    "page": IDL2.Nat,
    "totalCount": IDL2.Nat,
    "pageSize": IDL2.Nat,
    "items": IDL2.Vec(Sloka2)
  });
  return IDL2.Service({
    "getChapter": IDL2.Func([IDL2.Nat], [IDL2.Opt(ChapterMeta2)], ["query"]),
    "getChapterSlokas": IDL2.Func([IDL2.Nat], [IDL2.Vec(Sloka2)], ["query"]),
    "getChapters": IDL2.Func([], [IDL2.Vec(ChapterMeta2)], ["query"]),
    "getDailySloka": IDL2.Func([], [IDL2.Opt(Sloka2)], ["query"]),
    "getSloka": IDL2.Func([IDL2.Nat, IDL2.Nat], [IDL2.Opt(Sloka2)], ["query"]),
    "searchSlokas": IDL2.Func(
...
class Backend {
  ...
  async getChapterSlokas(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getChapterSlokas(arg0);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getDailySloka() {
    if (this.processError) {
      try {
        const result = await this.actor.getDailySloka();
  ...
  async getSloka(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.getSloka(arg0, arg1);
        return from_candid_opt_n2(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async searchSlokas(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.searchSlokas(arg0, arg1, arg2);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function useChapter(id2) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["chapter", id2],
    queryFn: async () => {
      if (!actor || id2 === void 0) return null;
      return actor.getChapter(BigInt(id2));
    },
    enabled: !!actor && !isFetching && id2 !== void 0,
    staleTime: 1e3 * 60 * 10
  });
}
function useSloka(chapter, number2) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["sloka", chapter, number2],
    queryFn: async () => {
      if (!actor || chapter === void 0 || number2 === void 0) return null;
      return actor.getSloka(
        BigInt(chapter),
        BigInt(number2)
      );
    },
    enabled: !!actor && !isFetching && chapter !== void 0 && number2 !== void 0,
    staleTime: 1e3 * 60 * 10
  });
}
function useChapterSlokas(chapterId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["chapter-slokas", chapterId],
    queryFn: async () => {
      if (!actor || chapterId === void 0) return [];
      return actor.getChapterSlokas(BigInt(chapterId));
    },
    enabled: !!actor && !isFetching && chapterId !== void 0,
    staleTime: 1e3 * 60 * 10
  });
}
function useSearchSlokas(keyword, page = 0, pageSize = 20) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useDailySloka() {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["daily-sloka"],
    queryFn: async () => {
      if (!actor) return null;
      return actor.getDailySloka();
    },
    enabled: !!actor && !isFetching,
    staleTime: 1e3 * 60 * 60
  });
...
export {
  ...
  useChapters as b,
  useChapter as c,
  useChapterSlokas as d,
  useSloka as e,
  useSearchSlokas as f,
  useConstant as g,
  usePresence as h,
  isHTMLElement as i,
